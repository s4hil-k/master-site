...
if ($element['slidenav'] == 'outside' && ($element['text_color'] != $element['slidenav_outside_color'])) {
    if (!$element['text_color']) {
        ...
        $attrs_slidenav_container['uk-toggle'] = "cls: js-color-state uk-{$element['text_color']}; mode: media; media: @{$element['slidenav_outside_breakpoint']}";
        $attrs_slidenav_container['class'][] = "js-color-state";
    } else {
        $attrs_slidenav_container['uk-toggle'] = "cls: uk-{$element['slidenav_outside_color']} uk-{$element['text_color']}; mode: media; media: @{$element['slidenav_outside_breakpoint']}";
