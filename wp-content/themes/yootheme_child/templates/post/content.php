...
<!-- ...................CONTENT................................... -->
    <div class="uk-text-break" <?= get_attrs($attrs_content) ?> property="text"><?php echo wp_trim_words( get_the_content(), 40, '...' );?>
        <?php echo "<Br><a href=\"".esc_url( get_permalink($post))."\" class=\"uk-button uk-button-primary uk-button-small uk-margin\">Read More</a>"; ?>
    </div>
